...
interface CreatePostModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (post: { title: string; content: string; type: string }) => Promise<void> | void;
}
      ...
      <div className="w-full max-w-lg bg-surface-container-lowest rounded-2xl shadow-2xl p-8 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="bg-surface-container-low p-4 rounded-lg flex items-center gap-3">
            ...
            <p className="text-xs text-on-surface-variant">When the AI service is available, a summary will be generated after the post is saved.</p>
          </div>
